...
```bash
bin/qtl histogram --check-cache -d rgc_sp23_sidisdvcs --skimdir --focus-physics $(ls -d /cache/clas12/rg-c/production/spring23/pass1/*/dst/train/sidisdvcs/)
bin/qtl histogram -d rgc_sp23_sidisdvcs --skimdir --focus-physics $(ls -d /cache/clas12/rg-c/production/spring23/pass1/*/dst/train/sidisdvcs/)
```
