...
def engines = [
  out_ALERT: [
   ...
   new alert_atof_tot_sector_0(),
   new alert_atof_tot_sector_1(),
   new alert_atof_tot_sector_2(),
   new alert_atof_tot_sector_3(),
   new alert_atof_tot_sector_4(),
   new alert_atof_tot_sector_5(),
   new alert_atof_tot_sector_6(),
   new alert_atof_tot_sector_7(),
   new alert_atof_tot_sector_8(),
   new alert_atof_tot_sector_9(),
   new alert_atof_tot_sector_10(),
   new alert_atof_tot_sector_11(),
   new alert_atof_tot_sector_12(),
   new alert_atof_tot_sector_13(),
   new alert_atof_tot_sector_14(),
   new alert_start_time(),
  //  new alert_atof_tdc_minus_start_time_vs_tot_sector_0(), //  Leave these commented for now.
  //  new alert_atof_tdc_minus_start_time_vs_tot_sector_1(), //  Current clas12mon doesn't support 2d histogram timeline.
  ...
  //  new alert_atof_tdc_minus_start_time_vs_tot_sector_14(),
   ...
   new alert_ahdc_time_layer_number2(),
   new alert_ahdc_time_layer_number3(),
   new alert_ahdc_time_layer_number4(),
   new alert_ahdc_time_layer_number5(),
   new alert_ahdc_time_layer_number6(),
   new alert_ahdc_time_layer_number7(),
   new alert_ahdc_time_layer_number8(),
