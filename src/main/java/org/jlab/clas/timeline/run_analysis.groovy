...
def engines = [
  out_ALERT: [
    *(1..8).collect {ahdc_layer_number -> new alert_ahdc_residual_layer_wire (ahdc_layer_number) },
    *(1..8).collect {ahdc_layer_number -> new alert_ahdc_residual_LR_layer_wire (ahdc_layer_number) },
    new alert_ahdc_residual_layer(),
    new alert_ahdc_residual_LR_layer(),
    new alert_atof_time(),
