...
class alert_atof_tdc_minus_start_time_vs_tot_sector_11 {
          ...
          names.each{ name ->
            ...
            data.sort{it.key}.each{run,it->
              ...
              if (it.containsKey(name)){
                ...
                if (it.containsKey(variable + '_' + name)) gr.addPoint(it.run, it[variable + '_' + name], 11..11)
              }
